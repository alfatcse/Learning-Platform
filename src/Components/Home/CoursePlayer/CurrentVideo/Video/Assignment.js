...
import { useGetAssignmentQuery, usePostAssignmentMutation } from "../../../../../features/assignment/assignmentAPI";
import moment from "moment";
const Assignment = () => {
  const { assignmentId } = useParams();
  const {data:assignment,isError, isLoading, error }=useGetAssignmentQuery(assignmentId);
  const [postAssignment,{isSuccess,isLoading:submitLoading}]=usePostAssignmentMutation();
